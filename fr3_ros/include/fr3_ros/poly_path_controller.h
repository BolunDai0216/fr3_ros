...
class PolyPathController : public controller_interface::MultiInterfaceController<franka_hw::FrankaModelInterface, 
 ...
 public:
  ...
  PolyPathController() : dim(14), n_eq(7), n_in(0), qp(dim, n_eq, n_in) {};
